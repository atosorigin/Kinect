...
namespace Kinect.Plugins.PowerPoint2010
{
    public partial class KinectRibbon
    {
        ...
        {
            StartKinect.Image = global::Kinect.Plugins.PowerPoint2010.Properties.Resources.btnStop;
            StartKinect.Label = "Stop Kinect";
        }

        private void KinectManager_KinectStopped(object sender, EventArgs e)
        {
            StartKinect.Image = global::Kinect.Plugins.PowerPoint2010.Properties.Resources.btnStart;
            StartKinect.Label = "Start Kinect";
        }

        private void KinectManager_UserLost(object sender, EventArgs e)
        {
            btnCalibrate.Image = global::Kinect.Plugins.PowerPoint2010.Properties.Resources.user_red;
            btnCalibrate.Enabled = false;
        }

        private void KinectManager_UserFound(object sender, EventArgs e)
        {
            btnCalibrate.Image = global::Kinect.Plugins.PowerPoint2010.Properties.Resources.user_green;
